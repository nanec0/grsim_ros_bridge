...
if __name__ == "__main__":
    ...
    rospy.Subscriber("robot_blue_0/cmd_vel", SSL, cmd_blue_0_callback)
    rospy.Subscriber("robot_blue_1/cmd_vel", SSL, cmd_blue_1_callback)
    rospy.Subscriber("robot_blue_2/cmd_vel", SSL, cmd_blue_2_callback)
    rospy.Subscriber("robot_blue_3/cmd_vel", SSL, cmd_blue_3_callback)
    rospy.Subscriber("robot_blue_4/cmd_vel", SSL, cmd_blue_4_callback)

    rospy.Subscriber("robot_yellow_0/cmd_vel", SSL, cmd_yellow_0_callback)
    rospy.Subscriber("robot_yellow_1/cmd_vel", SSL, cmd_yellow_1_callback)
    rospy.Subscriber("robot_yellow_2/cmd_vel", SSL, cmd_yellow_2_callback)
    rospy.Subscriber("robot_yellow_3/cmd_vel", SSL, cmd_yellow_3_callback)
    rospy.Subscriber("robot_yellow_4/cmd_vel", SSL, cmd_yellow_4_callback)
